package others.morphological.autoparameter;

import basics.Tools;
import ij.process.ImageProcessor;
import java.io.IOException;
import java.util.Vector;
import others.morphological.BinaryRegion;
import others.morphological.FlatRegions;
import others.morphological.FlatRegions.RegionType;
...
public class AutoParameter
{
    ...
    public static int boxplotMean(ImageProcessor imageProcessor, double maxHolePixelSizePercentage) {
        ...
        flatRegions.boxPlot(0.33D, 0.01D);
