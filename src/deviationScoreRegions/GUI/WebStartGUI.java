...
public class WebStartGUI extends JFrame
        implements Runnable, ProgressListener
{
    ...
    private void initComponents()
    {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addComponent(this.jProgressBar1, -1, 529, 32767).addGroup(layout.createSequentialGroup().addComponent(this.label1, -2, -1, -2).addGap(18, 18, 18).addComponent(this.jButton1).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jButton2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jButton3).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jButton4)).addGroup(layout.createSequentialGroup().addComponent(this.label2, -2, -1, -2).addGap(1, 1, 1).addComponent(this.jComboBox1, -2, 89, -2).addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED).addComponent(this.jLabel2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.tfSize, -2, 65, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addComponent(this.jLabel1, -2, 49, -2)).addComponent(this.canvas1, -2, 450, -2)).addContainerGap()));

        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createSequentialGroup().addContainerGap().addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jComboBox1, -2, -1, -2).addComponent(this.jLabel2).addComponent(this.tfSize, -2, -1, -2).addComponent(this.jLabel1)).addComponent(this.label2, -2, -1, -2)).addGap(13, 13, 13).addComponent(this.canvas1, -2, 300, -2).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED).addGroup(layout.createParallelGroup(GroupLayout.Alignment.TRAILING).addComponent(this.label1, -2, -1, -2).addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE).addComponent(this.jButton1).addComponent(this.jButton2).addComponent(this.jButton3).addComponent(this.jButton4))).addPreferredGap(LayoutStyle.ComponentPlacement.RELATED, 16, 32767).addComponent(this.jProgressBar1, -2, -1, -2).addContainerGap()));
    ...
    private void loadSampleRessource() {
        Image i = Toolkit.getDefaultToolkit().createImage(getClass().getResource("/resources/" + this.jComboBox1.getSelectedItem().toString() + ".jpg"));
    ...
    private void selectFile() {
        ...
        if (returnVal == 0)
            try {
                ...
                Logger.getLogger(WebStartGUI.class.getName()).log(Level.SEVERE, null, ex);
            }
    }
    ...
    private void jButton1ActionPerformed(ActionEvent evt) {
        this.method = Method.our;
        startSegmentation();
    }

    private void jButton2ActionPerformed(ActionEvent evt) {
        this.method = Method.morph;
        startSegmentation();
    }

    private void jButton3ActionPerformed(ActionEvent evt)
    {
        this.method = Method.fuzzy;
        startSegmentation();
    }

    private void jButton4ActionPerformed(ActionEvent evt) {
        this.method = Method.video;
        startSegmentation();
    }
