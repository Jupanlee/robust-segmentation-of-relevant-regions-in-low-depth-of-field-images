...
public class DeviationScoreRegions_Tuned
        implements Batch.Batchable
{
    ...
    int approxMapReconstructSize = (int)(this.morphImageSize * 0.25D);
    ...
    public static void noiseTest(int size) throws IOException {
        for (String fileName : Tools.getFilesFromDirectory("../../../data/batch/images/flickr", ".jpg")) {
