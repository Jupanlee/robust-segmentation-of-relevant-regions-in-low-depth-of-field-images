...
public class DeviationScoreRegions_Tuned implements Batchable {
    ...
    public DeviationScoreRegions_Tuned() {
        ...
        this.approxMapReconstructSize = (int)((double)this.morphImageSize * 0.25D);
    ...
    public DeviationScoreRegions_Tuned(ProgressListener progressListener) {
        this.blur = this.preBlur;
        this.scoreImageThreshold = 33;
        this.scoreClusteringThreshold = 127.5D;
        this.finalPower = 4.0D;
    ...
    public static void noiseTest(int size) throws IOException {
        Iterator i$ = Tools.getFilesFromDirectory("../../../data/batch/images/flickr", ".jpg").iterator();
        ...
        while(i$.hasNext()) {
            ...
            for(double noiseSize = 0.0D; noiseSize < 10.0D; ++noiseSize) {
                ...
                (new DeviationScoreRegions_Tuned()).run(noised);
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] sizes = new int[]{650, 800, 1024};
        Batch.run(new DeviationScoreRegions_Tuned(), sizes, "../../../data/batch/images/flickr");
    }
    ...
    public ImageProcessor run(ImageProcessor original) {
        ...
        DEBUG.println("scorePointDensity == " + scorePointDensity);
